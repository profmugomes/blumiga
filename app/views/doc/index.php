...
<div class="doc-content">
    ...
    <div class="card-grid">
        <a href="<?= route('doc.instalacao') ?>" class="card card-link">
        ...
        <a href="<?= route('doc.rotas') ?>" class="card card-link">
